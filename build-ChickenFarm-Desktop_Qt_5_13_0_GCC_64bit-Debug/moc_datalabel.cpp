/****************************************************************************
** Meta object code from reading C++ file 'datalabel.h'
**
...
#include <memory>
#include "../Widget/Label/datalabel.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'datalabel.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(5, 35, 8) // "fontSlot"

    },
    "DataLabel\0fontChange\0\0setValue\0val\0"
    "fontSlot"
};
...
void DataLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DataLabel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (DataLabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataLabel::fontChange)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DataLabel::staticMetaObject = { {
    &QLabel::staticMetaObject,
    qt_meta_stringdata_DataLabel.data,
    qt_meta_data_DataLabel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
