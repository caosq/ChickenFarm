...
QT_MOC_LITERAL(3, 19, 5) // "pvArg"

    },
    "Device\0valChanged\0\0pvArg"
};
...
void Device::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->valChanged((*reinterpret_cast< void*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Device::*)(void * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Device::valChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Device::valChanged(void * _t1)
{
